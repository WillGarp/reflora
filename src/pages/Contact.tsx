...
export function Contact() {
  ...
  return (
    <>
      <PageIntro eyebrow="Contato" title="Vamos entender o seu desafio." text="Envie uma mensagem ou fale diretamente com a equipe Reflora. O primeiro passo é uma boa conversa." />
      <section className="contact-section">
        <div className="contact-info">
          ...
          <p>Atendimento para projetos públicos, corporativos e particulares.</p>
        </div>
